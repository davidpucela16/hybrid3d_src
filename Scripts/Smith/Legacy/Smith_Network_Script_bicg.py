...
def GetEnteringExiting(vertex_to_edge, init):
    ...
    for i in vertex_to_edge:
        ...
        c+=1
    return(label)
from PrePostTemp import GetEdgeConcentration
first_field=GetEdgeConcentration(prob)
second_field=GetEnteringExiting(vertex_to_edge, startVertex)
